...
class CalendarTool:
    ...
    def __init__(self, client_secret_file: str, create_service_func) -> None:
        ...
        self._create_service = create_service_func # Store the passed function
        self._init_service()
    ...
    def _init_service(self) -> None:
        ...
        """
        self.service = self._create_service( # Use the stored function
...
if not CLIENT_SECRET_FILE:
    raise ValueError("GOOGLE_CLIENT_SECRET_FILE environment variable not set.")
...
calendar_tool = CalendarTool(client_secret_file=CLIENT_SECRET_FILE, create_service_func=create_service)
...
if __name__ == '__main__':
    print(f"Google Calendar MCP Server listening on port 8001.")
    print("Ensure GOOGLE_CLIENT_SECRET_FILE is set in your .env and points to client_secret.json.")